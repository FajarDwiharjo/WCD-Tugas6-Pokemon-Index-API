...
import { getTypeBadgeColor } from '../../Utility/getTypeBadgeColor';
    ...
    <Link to={`/pokemon/${pokemon.id}`} className="transition-transform transform hover:scale-105">
      <div
        className={`border rounded-xl shadow-md p-4 transition-all duration-500 ease-in-out
          ...
          bg-white text-[#312A16] border-none shadow-xl
          dark:bg-[#4F5784] dark:text-[#CED5E9] dark:border-[#DDE5F7] dark:shadow-[#606890]
        `}
      >
        <h2
