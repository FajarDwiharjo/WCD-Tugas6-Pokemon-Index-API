...
const Header: React.FC<HeaderProps> = ({ onSearch, onSortChange, children }) => {
  ...
  return (
    <header className="bg-[#DAD5C1] text-[#252A3E] dark:bg-[#252A3E] dark:text-white py-4 shadow-xl border-b-2 border-[#97A0CC]/35 dark:border-[#97A0CC]/35">
              ...
              <div className="flex sm:hidden flex-row items-center gap-2 w-full">
                <div className="flex-2">
                  <select
                    ...
                    className="px-4 py-2 rounded-md bg-white text-[#252A3E] border border-[#97A0CC] w-full sm:w-auto hover:bg-[#E4E0D4] hover:text-[#3D4466] focus:outline-none focus:ring-2 focus:ring-[#97A0CC] transition-all dark:bg-[#3D4466] dark:text-[#97A0CC] dark:border-[#4F5784] dark:hover:bg-[#4F5784] dark:hover:text-white"
                  >
